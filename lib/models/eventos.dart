...
final List<Evento> eventos = [
  Evento(
    ...
    eventoDescri:"Venha se juntar a nós na terceira edição do Anime Station! O local está em processo de definição, mas garantiremos que seja de fácil acesso para todos. Prepare-se para um dia repleto de diversão, com concursos de cosplay e kpop, bate-papo com cosplayers, sessões de karaoke, shows ao vivo, salas temáticas e muito mais. Não perca a oportunidade de se divertir conosco neste evento imperdível!",
    eventoLocal: "Local: Local a definir São Paulo, SP",
    siteUrl:"https://www.sympla.com.br/evento/anime-station-terceira-edicao/2400550?referrer=www.google.com",
